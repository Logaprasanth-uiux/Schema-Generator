...
export const RequirementCategoryChip: React.FC<RequirementCategoryChipProps> = ({
  ...
  } else if (normalized.includes('allocation')) {
  ...
  } else if (normalized.includes('workflow') || normalized.includes('process')) {
  ...
  } else if (normalized.includes('lookup') || normalized.includes('mapping')) {
